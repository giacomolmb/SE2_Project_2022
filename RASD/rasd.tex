...
\begin{itemize}
    ...
    gets ready to fill in the report form. First of all he selects what kind of harvest he has collected from the drop-down menu, then he enters the quantities of interest required, 
...
Alloy is an open source language and analyzer for software modeling\cite{Alloy}. The following section shows a formal model of the problem and some possible worlds are provided.
