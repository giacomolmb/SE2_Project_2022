...
\begin{enumerate}[label=\textbf{R\arabic*}]
    ...
    \item \label{req:farmerReport3} The system shall retrieve data from sensors and attach it to reports.
    \item \label{req:farmerReport4} The system shall retrieve data from weather stations and attach it to reports.
