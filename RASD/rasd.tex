...
\subsubsection{Goals}
    \begin{center}
        ...
        Goal & Description \\ 
        \hline\hline
        G1 \label{goal:g1} & Allow Telangana's Policy Makers to monitor local agriculture\\ 
        \hline
        G2 \label{goal:g2} & Allow farmers to receive assistance or rewards based on their performance\\ 
        \hline
        G3 \label{goal:g3} & Allow farmers to request and receive help \\
        \hline
        G4 \label{goal:g4} & Create a farmer's network to promote collaboration and mutual aid \\ 
        \hline
...
\begin{enumerate}
    \item \textbf{Policy maker registration}
    ...
    \item \textbf{Rewarding of good-performing farmers}
        ...
        \end{longtable}
    \newpage
    \item \textbf{Creation of a forum discussion} 
        \begin{longtable}{p{0.26\linewidth}p{0.75\linewidth}}
            \toprule
            ...
            \textbf{Flow of events} & 
            \begin{enumerate}
                \item The farmer creates a new forum discussion about a specific topic of its interest
                \item The system publishes the thread on the farmer's forum
                \item The PM notice the new thread in the discussions list
                \item The PM opens the discussion and submits his answer
                \item The farmer checks his discussion and reads the answer submitted
                \item The farmer has solved his problem and closes the discussion
                \item The system removes the thread from the forum
            \end{enumerate} \\
            \midrule
            \textbf{Exit conditions} & The farmer closes the discussion after reading the answer\\
            \midrule
            \textbf{Exceptions} & 
            \begin{itemize}
                \item The farmer finds a solution to his problem by himself and closes the discussion 
            \end{itemize} \\
            \bottomrule
...
\begin{figure}[h]
    \includegraphics[scale=0.46]{trac_matrix.png} 
    \end{figure}
\newpage
