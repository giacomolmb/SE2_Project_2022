...
\begin{itemize}
    ...
    Guepequesh works as PM at the Ministry of Agriculture, Food and Forestry of Telengana. Like every end of the quarter,
     it's time to designate who the top performing farmers of the period were. Guepequesh logs in with his credentials to
      ...
      \item \textit{Farmers request for help and suggestions by agronomists and other farmers}\\
      Marrakesh
...
In this section the different types of users of the system will be analyzed. DREAM has two categories of users:
\begin{itemize}
    \item \textbf{Farmers}\\
