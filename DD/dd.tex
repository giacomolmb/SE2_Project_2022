...
IoT sensors are connected via MQTT protocol to a MQTT broker which periodically retrieves the data collected by sensors.\\
...
\begin{itemize}
    ...
    Sensors for measuring soil moisture and irrigation are 
